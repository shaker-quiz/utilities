...
export namespace ServiceFeatures {
    ...
    export let Landing: ("Games" | "Game" | "Home" | "Registration")[];
    export let Locations: ("Cities" | "City" | "Countries" | "Country" | "Home" | "Region" | "Regions" | "Venue" | "Venues")[];
    export let Studio: ("Checkin" | "Games" | "Users" | "Cities" | "City" | "Countries" | "Country" | "Game" | "Home" | "Region" | "Regions" | "Registration" | "Registrations" | "Theme" | "Themes" | "User" | "Venue" | "Venues")[];
    let Users_1: ("Checkin" | "Users" | "User")[];
    export { Users_1 as Users };
    export let MiniApp: ("Games" | "Game" | "Home" | "Registration")[];
}
